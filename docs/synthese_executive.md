...
Les obligations sont des instruments financiers de la famille des produits
de placement à revenu fixe. Ils servent au financement de la dette
...
l'ensemble des flux, en utilisant le facteur d'actualisation propre à chaque
échéance. Le prix d'acquisition d'une obligation est donné en *pourcentage du pair*.

Quand une obligation s'échange sous le pair, le remboursement final excède
le montant prêté, il s'agit d'une prime de remboursement. A contrario quand
une obligation s'échange au dessus du pair, le remboursement final est
inférieur au montant prêté, il y a donc une prime d'émission à l'acquisition
du contrat.

Pour ce qui est des obligations souveraines l'Agence France Trésor publie
pour chaque titre le taux de coupon et les échéances, le prix de chaque
adjudication, et leur taux d'intérêt moyen. Mécaniquement quand
l'adjudication est au dessus de 100%, le taux d'intérêt est en dessous du
taux de coupon. Inversement, quand l'adjudication est en dessous de 100% le taux
d'intérêt est au dessus du taux de coupon. Le taux d'intérêt effectif n'est
égal au taux de coupon que lorsque l'émission est à 100% du pair.
...
recouvrement est organisé selon les articles 125A et 125D du CGI.
...
Ainsi, nous montrons que c'est par un glissement non justifié entre taux de
coupon (qui n'est rien d'autre qu'un taux contractuel servant à fixer la
valeur des flux intermédiaires et ne pouvant à lui seul caractériser un
revenu) et taux d'intérêt (qui caractérise l'enrichissement en terme
économique et peut être déterminé par la méthode actuarielle), que la
doctrine, dans le cas des obligations acquises au dessus du pair, se
retrouve à lever une nouvelle taxe, non disposée par le CGI, sur la
prime d'émission.
